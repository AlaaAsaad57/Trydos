    ...
    <WithHeader {...{ story, globalHeader: config.header }}>
      <WithSeeMore {...{ story, action }}>
        <div style={styles.videoContainer} className="">
          ...
          {story?.link && (
            <a
              className="absolute w-full bg-[#00000026] flex justify-center items-center z-[999999999]  bottom-[70px] mx-auto left-0 right-0 text-white text-center text-lg regular underline"
              href={story.link}
              target="_self"
              onClick={() => {
                SelectStory(null);
