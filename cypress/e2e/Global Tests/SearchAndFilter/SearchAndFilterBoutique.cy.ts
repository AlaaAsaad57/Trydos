describe("Should Choose Any Boutique & Open Its Page In Order To Filter Products & Search For A Specific Product", () => {
  ...
  it("Should Click On Any Boutique", () => {
    cy.get("[data-cy=boutiques]", { timeout: 15000 });
    cy.get(".offer-widget:nth-child(4)", { timeout: 10000 }).click({
      force: true,
    });
    cy.log("✅✅ An Boutiue selected");
  });
  it("Should Verifications The Boutique Page Opened", () => {
    cy.get("[data-cy=boutiqueOpen]", { timeout: 15000 });
