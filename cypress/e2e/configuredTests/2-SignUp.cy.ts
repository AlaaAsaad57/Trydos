describe("2-1 Signup Successful Attempt should login to 3 servers", () => {
  before(() => {
...
describe("2-2 Signup UnSuccessful Attempt should show error message to user", () => {
  it("Should Ensure The User Has Not LogIn Previously", () => {
    cy.WaitUntilLoadWebsiteAndlogoutAndViewport();
  });
  it("Should Click On Login Icon & Open Its Interface", () => {
...
describe("2-3 Should show user is already registered when registering with registered number", () => {
  it("Should Ensure The User Has Not LogIn Previously", () => {
    cy.WaitUntilLoadWebsiteAndlogoutAndViewport();
  });
  it("Should Click On Login Icon & Open Its Interface", () => {
...
describe("2-4 Should show user is already registered when registering with registered number & Cancel & Take A Look At The App", () => {
  it("Should Ensure The User Has Not LogIn Previously", () => {
    cy.WaitUntilLoadWebsiteAndlogoutAndViewport();
  });
  it("Should Click On Login Icon & Open Its Interface", () => {
...
describe("2-5 Should show user is already registered when registering with registered number & Login & Continue", () => {
  it("Should Ensure The User Has Not LogIn Previously", () => {
    cy.WaitUntilLoadWebsiteAndlogoutAndViewport();
  });
  it("Should Click On Login Icon & Open Its Interface", () => {
...
describe("2-6 Signup Successful Attempt & complete the profile", () => {
  it("Should Ensure The User Has Not LogIn Previously", () => {
    cy.WaitUntilLoadWebsiteAndlogoutAndViewport();
  });
  it("Should Click On Login Icon & Open Its Interface", () => {
...
describe("2-7 Should show user is already registered when registering with registered number and write your name", () => {
  it("Should Ensure The User Has Not LogIn Previously", () => {
    cy.WaitUntilLoadWebsiteAndlogoutAndViewport();
  });
  it("Should Click On Login Icon & Open Its Interface", () => {
  ...
  it("Should write name and  Welcom Message Apperead", () => {
    cy.get('[data-cy="InputFiledForName"]').as("phoneInput").focus(); // Focus on the input
    cy.window().then((win) => {
      win.isKeyboardOpen = true;
    });
    ...
    cy.wait("@update-name").then((inter) => {
