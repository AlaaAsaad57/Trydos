  ...
  >
    ...
    <g fill="#006b3f" transform="translate(600 300)">
      ...
      <g id="b">
        ...
        />
        <use xlinkHref="#a" width="100%" height="100%" transform="scale(-1)" />
      </g>
      <use xlinkHref="#b" width="100%" height="100%" transform="rotate(36)" />
      <use xlinkHref="#b" width="100%" height="100%" transform="rotate(72)" />
      <use xlinkHref="#b" width="100%" height="100%" transform="rotate(108)" />
