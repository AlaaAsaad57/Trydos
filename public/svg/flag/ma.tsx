...
const Ma = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600" {...props}><path d="M-900 0H0v600h-900z" style="fill:#c1272d;fill-opacity:1;stroke:none" transform="scale(-1 1)"/><path d="m450 224.315-44.467 136.87 116.401-84.559h-143.87l116.403 84.559z" style="fill:none;stroke:#006233;stroke-width:14.62993431;stroke-miterlimit:4;stroke-dasharray:none"/></svg>
);
