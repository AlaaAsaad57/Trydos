...
const Hk = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <use xlinkHref="#a" transform="rotate(72 450 300)" />
    <use xlinkHref="#a" transform="rotate(144 450 300)" />
    <use xlinkHref="#a" transform="rotate(216 450 300)" />
    <use xlinkHref="#a" transform="rotate(288 450 300)" />
  </svg>
);
