...
const My = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M0 0h2800v1400H0z" style="fill:#cc0001" />
    <path id="a" d="M0 1300h2800v100H0z" style="fill:#fff" />
    <use xlinkHref="#a" transform="translate(0 -200)" />
    <use xlinkHref="#a" transform="translate(0 -400)" />
    <use xlinkHref="#a" transform="translate(0 -600)" />
    <use xlinkHref="#a" transform="translate(0 -800)" />
    <use xlinkHref="#a" transform="translate(0 -1000)" />
    <use xlinkHref="#a" transform="translate(0 -1200)" />
    <path d="M0 0h1400v800H0z" style="fill:#010066" />
    <path
