...
const Gd = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <use xlinkHref="#c" transform="matrix(33 0 0 33 250 150)" />
    <use xlinkHref="#d" x="-100" />
    <use xlinkHref="#c" id="d" transform="matrix(19.5 0 0 19.5 250 21)" />
    <use xlinkHref="#d" x="100" />
    <use xlinkHref="#d" x="-100" y="258" />
    <use xlinkHref="#d" y="258" />
    <use xlinkHref="#d" x="100" y="258" />
    <path
      fill="#ce1126"
