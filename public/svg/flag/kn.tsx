...
const Kn = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#a)">
      ...
      <path stroke="#fcd116" stroke-width="210" d="M0 500 750 0" />
      <path stroke="#000" stroke-width="150" d="M0 500 750 0" />
      <g id="d" fill="#fff" transform="rotate(-33.69 514.716 -777.095)">
        <g id="c">
