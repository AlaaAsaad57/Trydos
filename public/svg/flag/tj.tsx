...
const Tj = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g fill="#f8c300">
      ...
      />
      <use xlinkHref="#a" transform="matrix(-1 0 0 1 1400 0)" />
      <path
        id="b"
      ...
      />
      <use xlinkHref="#b" transform="rotate(9.37 700 804)" />
      <use xlinkHref="#b" transform="rotate(18.74 700 804)" />
      <path
        fill="none"
        stroke="#f8c300"
        stroke-width="16"
      ...
      <g transform="translate(700 380)">
        ...
        <g id="d">
          <use xlinkHref="#c" transform="translate(-70 -121.244)" />
          <use xlinkHref="#c" transform="translate(-121.244 -70)" />
          <use xlinkHref="#c" transform="translate(-140)" />
        </g>
