...
const QuickIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    id="_20x20"
    data-name="20x20"
      ...
      <g id="flash-sale-2">
        <g id="Group_10830" data-name="Group 10830">
          <path
            ...
            d="M6.217,18.727l1.857-5.769H2.864a.869.869,0,0,1-.827-1.135L5.543.925a.869.869,0,0,1,.827-.6h4.577a.869.869,0,0,1,.827,1.135L9.987,7.019h5.581A.86.86,0,0,1,16.257,8.4l-8.791,11a.721.721,0,0,1-1.249-.671Z"
            fill="#ffae72"
          />
          <path
            id="Path_21422"
            data-name="Path 21422"
            d="M16.255,8.4l-8.787,11a.722.722,0,0,1-1.252-.671L7.611,14.4a7.981,7.981,0,0,0,4.157-7.38h3.8a.864.864,0,0,1,.69,1.381Z"
            opacity="0.1"
          />
          <path
            id="Path_21423"
            data-name="Path 21423"
            d="M6.914,20a1.064,1.064,0,0,1-.505-.131,1.018,1.018,0,0,1-.5-1.239l1.722-5.348H2.864A1.191,1.191,0,0,1,1.73,11.725L5.236.827A1.188,1.188,0,0,1,6.371,0h4.576a1.191,1.191,0,0,1,1.134,1.556L10.429,6.7h5.139a1.183,1.183,0,0,1,.947,1.893L7.718,19.6a1.023,1.023,0,0,1-.8.4Zm-.391-1.172a.4.4,0,0,0,.69.37L16,8.194a.538.538,0,0,0-.437-.853H9.987A.323.323,0,0,1,9.68,6.92l1.788-5.562a.547.547,0,0,0-.52-.714H6.371a.545.545,0,0,0-.52.379l-3.506,10.9a.546.546,0,0,0,.52.713h5.21a.322.322,0,0,1,.307.421Z"
            fill="#131319"
          />
        </g>
