...
const RedeemedFlag = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  <defs>
    <linearGradient id="redeemedGradient" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" style="stop-color:#f64f64;stop-opacity:1" />
      <stop offset="100%" style="stop-color:#d73a49;stop-opacity:1" />
    </linearGradient>
  </defs>
  <path d="M0 2 L50 2 L55 10 L50 18 L0 18 Z" fill="url(#redeemedGradient)" />
  <text x="27.5" y="13" font-family="Arial, sans-serif" font-size="8" font-weight="bold" text-anchor="middle" fill="white">
    REDEEMED
  </text> 
</svg>
);
