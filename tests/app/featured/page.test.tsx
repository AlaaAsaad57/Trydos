// The /featured listing page (server component) and its metadata.
// The cases are shared with /flashDeals — see ../listingPageHarness.tsx.
...
listingPageCases(
  "featured",
  () => import("app/(client)/[lang]/featured/[[...filters]]/page") as any,
