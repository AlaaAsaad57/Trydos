...
function FlashDealBannerCart({ end_data }) {
  ...
  return (
    <div
      className={`flex-none pr-[5px] pl-[8px] text-nowrap flex-row h-full gap-[2px] items-center rounded-[10px] relative bg-[#FFF3E8] text-[#FF6200] text-[9px] medium min-w-[125px]`}
      style={{
...
export default FlashDealBannerCart;
