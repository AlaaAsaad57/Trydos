...
export const MapElement: React.FC<MapProps> = memo(
  ({ center, expanded, setLocation, cordinates }) => {
    ...
    let iconSvg = `<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#f64f64" version="1.1" id="Capa_1" width="30px" height="30px" viewBox="0 0 395.71 395.71" xmlSpace="preserve">
    <g>
