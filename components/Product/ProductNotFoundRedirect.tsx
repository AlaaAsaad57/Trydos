...
/**
 * Navigates away from an intercepted (modal) route whose product does not exist.
 *
 ...
 *
 * `replace` rather than `push` so the dead product URL does not sit in history
 * and bounce the user straight back into this redirect on Back.
 */
export default function ProductNotFoundRedirect({ href }: { href: string }) {
