...
function PointsSlider({isActiveTopSlide,setActiveTopSlide,activeIndex,colors}) {
  ...
  return (
    ...
    {!isActiveTopSlide&&     
     ...
     {colors.map((img,i)=>(
        <div className={`slider-point-item w-${getSize(i)} ${activeIndex===i&&'active-point-item'}`}>
            {getSize(i)===2?
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="2" height="2">
            <g >
              <g  stroke="#3c3c3c" stroke-width="0.3">
        ...
        <g >
          <g id="Ellipse_4-2" data-name="Ellipse 4"  fill="none" stroke="#3c3c3c" stroke-width="0.3">
