...
function ChatMessage(props) {
                  ...
                  <div className="audio-message">
                    ...
                    <div className="player-cont">
                      <div className="wave-absolute">
                        ...
                        !Number.isNaN(showTime(AudioRef.current?.duration)) &&
  ...
  useEffect(() => {
    document.querySelectorAll<any>(".message-element").forEach((a) => {
