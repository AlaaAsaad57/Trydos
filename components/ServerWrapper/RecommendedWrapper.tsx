 ...
 * recommendations in a shared entry would be shown to everybody else.
 *
 * It used to live inside BoutiquesListWrapper, whose own data is now cached.
 * The caller renders it in its own <Suspense> and passes it in as `children`,
 * so the offers section can come from the cache while this streams in.
 */
export default async function RecommendedWrapper({ lang, currency: currencyData }) {
