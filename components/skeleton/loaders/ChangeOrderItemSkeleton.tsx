...
const ChangeOrderItemSkeleton = () => {
  return (
    <div className="flex flex-col items-center justify-center p-10 min-h-[500px] max-w-lg mx-auto">
      ...
      <div className="flex flex-row gap-8 w-full justify-center mb-12">
