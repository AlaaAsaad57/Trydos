...
async function ProductDescriptorsWrapper({ priceQtyPromise, isRtl }) {
  let descriptorsData = await priceQtyPromise;
  let descriptors = descriptorsData.descriptors;
  if (!descriptors || descriptors?.length === 0) return <></>;
  return (
    <ProductDescriptors isRtl={isRtl}>
...
export default ProductDescriptorsWrapper;
