...
export default function AlreadyExistScreen({
  ...
  return (
    <div className="w-full h-full flex flex-col items-start bg-[#F4F8FF] font-quicksand relative" style={{ backgroundColor: '#F4F8FF' }}>
      ...
      <div className="w-full px-xd-30 h-1/2 flex items-end justify-start">
        <div className="flex flex-col items-start justify-start w-full">
          ...
          <div className="flex items-center gap-xd-2 mt-xd-6">
            <p className="text-xd-12 font-normal text-[#1D1D1D] text-trim-descend">
              +{phone}
            </p>
      ...
      <div className="w-full h-1/2 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center gap-xd-30 px-xd-15 pb-xd-45 w-full max-w-xd-390">
          <button
            onClick={onLogIn}
