...
function ConfirmMobilePhoneWidget() {
  ...
  return (
    <>
      ...
      <div className="w-auto  min-h-[200px] min-w-[350px]  h-auto p-[23px] flex-col items-end justify-center bg-[#f8f8f8] fixed rounded-[10px]  z-[99999999999] left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div
          onClick={() => {
