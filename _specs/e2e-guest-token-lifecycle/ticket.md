...
created_at: 2026-08-19   # YYYY-MM-DD
updated_at: 2026-08-19   # YYYY-MM-DD (bumped on every state change)
links:                   # OPTIONAL delivery links — metadata only, NOT workflow state
  ...
  github: https://github.com/AlaaAsaad57/Trydos/pull/96 # PR URL (set by /publish-pr after publishing; never drives state)
---

# Ticket Record — e2e-guest-token-lifecycle
