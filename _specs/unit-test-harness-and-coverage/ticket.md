...
links:                   # OPTIONAL delivery links — metadata only, NOT workflow state
  ...
  github: https://github.com/AlaaAsaad57998/Trydos/pull/86   # PR URL (set by /publish-pr after publishing; never drives state)
---

# Ticket Record — unit-test-harness-and-coverage
