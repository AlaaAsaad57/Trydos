...
created_at: 2026-08-11   # YYYY-MM-DD
updated_at: 2026-08-11   # YYYY-MM-DD (bumped on every state change)
links:                   # OPTIONAL delivery links — metadata only, NOT workflow state
  ...
  github: https://github.com/AlaaAsaad57998/Trydos/pull/90 # PR URL (set by /publish-pr after publishing; never drives state)
---

# Ticket Record — unit-tests-authed-fetch-and-tokens
