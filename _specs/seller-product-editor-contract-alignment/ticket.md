...
created_at: 2026-07-20   # YYYY-MM-DD
updated_at: 2026-07-20   # YYYY-MM-DD (bumped on every state change)
links:                   # OPTIONAL delivery links — metadata only, NOT workflow state
  ...
  github: https://github.com/AlaaAsaad57998/Trydos/pull/78   # PR URL (set by /publish-pr after publishing; never drives state)
---

# Ticket Record — seller-product-editor-contract-alignment
...
- state: implementation-in-progress
  ...
  by: reviewer
  timestamp: 2026-07-20
  note: attempt 1 — AC-1 failed as written; nine behavioural criteria unverified
- state: implementation-in-progress
  event: implementation-resumed
  by: developer
  timestamp: 2026-07-20
