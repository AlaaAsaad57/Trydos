...
- stage: implement
  ...
  by: developer
  timestamp: 2026-08-31
  blocker_id: BLK-CACHE-EXPOSURE-01
- stage: implement
  ...
  timestamp: 2026-08-31
  blocker_id: BLK-CACHE-EXPOSURE-01
  evidence_ref: "https://github.com/AlaaAsaad57/Trydos/pull/114 — BUG-1 fixed on
    fix/personal-pages-publicly-cacheable, with tests/next-config.test.ts seen red
    before the fix and green after; full unit suite 1978 passed"
