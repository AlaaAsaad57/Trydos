...
state: spec-complete     # AUTHORITATIVE workflow state (see allowed values below)
status: active           # orthogonal health flag: active | blocked
owner: developer         # accountable role/person (em | developer | ai_agent | name)
created_at: 2026-07-30   # YYYY-MM-DD
updated_at: 2026-07-30   # YYYY-MM-DD (bumped on every state change)
...
# Ticket Record — gated-upload-migration
