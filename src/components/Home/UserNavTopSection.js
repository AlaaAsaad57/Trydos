    ...
    <div className='user-nav-container'>
        ...
        {loginOpen&&<LoginWidget loginSuccessVar={loginSuccessVar} setLoginSucces={(e)=>setLoginSucces(e)} close={()=>openLogin(false)}/>}
       {
        ...
        <div className='nav-question-item'>
            <QuestionIcon/>
            <span aria-labelledby={language+'-light'} style={{display:"flex",color:"#F85555",fontSize:"14px",marginLeft:"5px",cursor:"pointer",}}>{translate(`${loginOpen?'Can':'Why'} We Know You ?`,language)}</span>
        </div>
